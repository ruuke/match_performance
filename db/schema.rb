...
ActiveRecord::Schema[7.0].define(version: 2024_05_12_172942) do
  ...
  create_table "player_match_performances", force: :cascade do |t|
    ...
    t.index ["player_id"], name: "index_player_match_performances_on_player_id"
  end
  ...
  add_foreign_key "match_participations", "teams"
